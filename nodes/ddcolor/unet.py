# Vendored from piddnad/DDColor (basicsr/archs/ddcolor_arch_utils/unet.py)
...
class CustomPixelShuffle_ICNR(nn.Module):
    ...
    def __init__(self, ni: int, nf: int = None, scale: int = 2, blur: bool = True, norm_type=NormType.Spectral, extra_bn=False):
        super().__init__()
...
class UnetBlockWide(nn.Module):
    ...
    def __init__(self, up_in_c: int, x_in_c: int, n_out: int, hook, blur: bool = False, self_attention: bool = False, norm_type=NormType.Spectral):
        super().__init__()
