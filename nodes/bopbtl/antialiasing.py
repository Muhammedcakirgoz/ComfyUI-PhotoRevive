# Vendored from microsoft/Bringing-Old-Photos-Back-to-Life (Global/detection_models/antialiasing.py)
# Copyright (c) Microsoft Corporation. Licensed under the MIT License.
# Original technique: https://github.com/adobe/antialiased-cnns
